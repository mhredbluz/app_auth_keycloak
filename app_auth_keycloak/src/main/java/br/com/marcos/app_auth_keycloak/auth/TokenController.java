package br.com.marcos.app_auth_keycloak.auth;
...
public class TokenController {
    ...
    public ResponseEntity<String> token(@RequestBody User user){
        ...
        var result = rt.postForEntity("http://localhost:8085/auth/realms/myRealm/protocol/openid-connect/token",entity, String.class);
